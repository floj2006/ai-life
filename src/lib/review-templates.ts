...
export const reviewCommentTemplates: ReviewCommentTemplate[] = [
  ...
  },
  {
    ...
    statuses: ["approved"],
    message:
      "Отличная работа, задание принято. Результат соответствует цели урока. Следующий шаг: попробуйте сделать еще 1-2 варианта на своей теме, чтобы закрепить навык.",
  },
  {
    id: "approved-solid",
    ...
    statuses: ["approved"],
    message:
      "Задание принято. Основа сделана правильно. Если захотите усилить результат, попробуйте сделать более смелую версию: усилить хук, композицию или точность промпта.",
  },
];
