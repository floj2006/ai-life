...
export const LEGAL_CONTACT_EMAIL = "neuropoai@gmail.com";
...
export const ROBOKASSA_PARTNER_OFFER_URL =
  "https://robokassa.com/media/dogovori/partners_oferta_30.pdf";

export const LEGAL_COMMON_NOTE =
  "Документ действует для сайта и платформы AI Easy Life, включая личный кабинет, уроки, задания и оплату тарифов.";
