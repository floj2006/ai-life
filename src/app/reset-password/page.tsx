...
const hints = [
  "Откройте письмо от Supabase и нажмите ссылку сброса.",
  "Введите новый пароль минимум из 6 символов.",
  "После сохранения вы автоматически попадете в кабинет.",
];
...
export default function ResetPasswordPage() {
  ...
  return (
    <main className="container-shell flex flex-1 flex-col justify-center gap-6 py-5">
      <section className="grid gap-4 md:grid-cols-[1.05fr_1fr] md:gap-6">
        <article className="surface fade-up relative overflow-hidden p-6 md:p-8">
          ...
          <p className="small-text mt-2 max-w-xl">
            Для безопасности ссылка восстановления работает ограниченное время.
          </p>
      ...
      <Link href="/auth" className="mx-auto text-sm font-semibold text-sky-700 transition hover:opacity-80">
        На страницу входа
      </Link>
    </main>
  );
